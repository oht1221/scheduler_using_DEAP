...
def main():
    ...
    toolbox.register("evaluate", evaluate2, standard, CNCs, JOB_POOL, VALVE_PRE_CNCs,
    ...
    indiv_optimized = SA.simulated_annealing(hof[0], 100, 0.97, standard, CNCs, JOB_POOL, VALVE_PRE_CNCs,
                                             LOK_FORGING_CNCs, LOK_HEX_CNCs, LEFT_OVER, )
